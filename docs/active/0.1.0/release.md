...
| [`auth-sync-foundation`](./auth-sync-foundation/spec.md) | 大 | 阶段 2 已完成（AC5/6/10/12） | bootstrap/register/token、设备管理与家庭码轮换、来源级限流（5 次锁定 15 分钟）、签名 cursor 快照/增量同步、pending_actions 逐项 ACK 与回执幂等；auth 18 例 + sync 15 例 PostgreSQL 集成测试 |
