...
import type { PublicErrorDefinition } from '../types.js'
...
/** SSE 事件定义 */
export const sseEvents = protocolCatalog.sseEvents
export type SseEventEntry = (typeof sseEvents)[number]
export type SseEventName = SseEventEntry['event']

/** 不变量定义 */
export const invariants = protocolCatalog.invariants
...
/** SSE 事件到定义的映射 */
export const sseEventMap = new Map(sseEvents.map((e) => [e.event, e]))
