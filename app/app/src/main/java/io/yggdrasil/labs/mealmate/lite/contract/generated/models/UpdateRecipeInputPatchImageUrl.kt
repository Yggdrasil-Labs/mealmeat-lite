...
sealed interface UpdateRecipeInputPatchImageUrl {
    @JvmInline
    value class ClearPatchValue(val value: ClearPatch) : UpdateRecipeInputPatchImageUrl

    @JvmInline
    value class SetUriPatchValue(val value: SetUriPatch) : UpdateRecipeInputPatchImageUrl
...
object UpdateRecipeInputPatchImageUrlSerializer : KSerializer<UpdateRecipeInputPatchImageUrl> {
    ...
    override fun serialize(encoder: Encoder, value: UpdateRecipeInputPatchImageUrl) {
        val jsonEncoder = encoder as? JsonEncoder ?: throw SerializationException("UpdateRecipeInputPatchImageUrl can only be serialized with Json")
    ...
    override fun deserialize(decoder: Decoder): UpdateRecipeInputPatchImageUrl {
        val jsonDecoder = decoder as? JsonDecoder ?: throw SerializationException("UpdateRecipeInputPatchImageUrl can only be deserialized with Json")
